                                                        ...
                                                        <?php foreach ($options as $option) { ?>
                                                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                                <label for="name" class="text-gray-700 block py-2">
                                                                    <?= htmlspecialchars($option['description'], ENT_QUOTES | ENT_HTML5, 'UTF-8', false) ?>
                                                                </label>
                                                                <textarea name="option[]" class="rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" rows="3"><?= $option['value'] ?></textarea>
