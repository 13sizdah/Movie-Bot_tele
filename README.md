# Movie & Series Download Telegram Bot 🤖🎬
# سورس ربات دانلود فیلم و سریال تلگرام متصل به درگاه پرداخت زرین پال + پنل تحت وب
با استفاده از این سورس می توانید یک ربات دانلود فیلم و سریال در تلگرام راه اندازی کنید و با استفاده از درگاه زرین پال، فیلم و سریال های خود را برای فروش در اختیار کاربران خود قرار دهید.

# ویژگی های سورس ربات دانلود فیلم و سریال

- امکان ایجاد دسته بندی و طبقه بندی فیلم و سریال
...
- نمایش اطلاعات کامل فیلم/سریال (سال، ژانر، کیفیت، IMDb، کارگردان، بازیگران)
- پشتیبانی از فیلم و سریال
- جستجوی پیشرفته در فیلم و سریال

# راه اندازی ربات
1. یک دیتابیس جدید بسازید و محتویات فایل دیتابیس `Database.sql` را بر روی دیتابیس ساخته شده آپلود(export) کنید.
2. **فایل `Database_Update_Movie.sql` را نیز اجرا کنید** تا فیلدهای جدید برای فیلم و سریال اضافه شوند.
3. اطلاعات دیتابیس ساخته شده , همچین تمامی اطلاعات خواسته شده را در فایل زیر جایگذاری کنید :
- `/config.php`
