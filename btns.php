...
$populars_count = 7; // تعداد نمایش فیلم و سریال محبوب(براساس ویو هر محصول)
$latests_count = 7; // تعداد نمایش آخرین فیلم و سریال
$cat_column_number = 2; // مدل نمایش دسته بندی ها (2 = در هر ردیف دو دسته بندی)
$products_column_number = 1; // مدل نمایش فیلم و سریال (1 = در هر ردیف یک محصول)


// منوی اصلی
$movies_btn = '🎬 فیلم‌ها';
$series_btn = '📺 سریال‌ها';
$vip_subscription = '🌟 اشتراک ویژه';
$admin_panel_btn = '⚙️ پنل مدیریت';

// کیبورد اصلی (برای کاربران عادی)
$main_keyboard = array(
    array($movies_btn, $series_btn),
    array($search_products),
    array($vip_subscription, $account),
    array($send_ticket)
);

// کیبورد ادمین (شامل دکمه پنل مدیریت)
$admin_keyboard = array(
    array($movies_btn, $series_btn),
    array($search_products),
    array($vip_subscription, $account),
    array($send_ticket),
    array($admin_panel_btn)
);
